...
function TabsOutline({ className, ...props }: React.ComponentProps<typeof TabsPrimitive.Root>) {
  return (
    <TabsPrimitive.Root
      data-slot="tabs"
...
function TabsOutlineList({ className, ...props }: React.ComponentProps<typeof TabsPrimitive.List>) {
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
...
export { TabsOutline, TabsOutlineList, TabsOutlineTrigger, TabsOutlineContent };
